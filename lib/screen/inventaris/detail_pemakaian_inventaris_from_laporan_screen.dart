...
class DetailPemakaianInventarisFromLaporanScreen extends StatefulWidget {
  final String? idLaporan;

  const DetailPemakaianInventarisFromLaporanScreen({super.key, this.idLaporan});

  @override
  State<DetailPemakaianInventarisFromLaporanScreen> createState() =>
      _DetailPemakaianInventarisFromLaporanScreenState();
}

class _DetailPemakaianInventarisFromLaporanScreenState
    extends State<DetailPemakaianInventarisFromLaporanScreen> {
  ...
  void initState() {
    super.initState();
    if (widget.idLaporan == null || widget.idLaporan!.isEmpty) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (mounted) {
          showAppToast(context, 'ID laporan tidak ditemukan.');
          context.pop();
        }
      });
      setState(() {
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: const Header(
            ...
            title: 'Detail Laporan Inventaris',
